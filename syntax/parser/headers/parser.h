...
#include "../../tokens/headers/parser_types.h"
...
struct ParserTypes {
    ...
    inline static std::string IDENTIFIER() { return "IDENTIFIER"; }
    ...
    // ===== Declaratives =====
    inline static std::string DECL_CALL() { return "DECLARATIVE_CALL"; }
    inline static std::string DECL_METHOD() { return "DECLARATIVE_METHOD"; }
