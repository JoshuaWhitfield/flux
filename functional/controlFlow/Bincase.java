...
import static functional.controlFlow.Fif.*;
import functional.controlFlow.Callables.VoidCallable;
import functional.models.TailCall;
import functional.controlFlow.Callables.BoolCallable;
import functional.controlFlow.Callables.AnyCallable;
...
public class Bincase {
    ...
    */
    ...
    public static <T> List<T> bincase_return_list(
        BooleanSupplier conditional,
        TailCall<List<T>> onTrue,
        Supplier<List<T>> onFalse
    ) {
        return conditional.getAsBoolean() ? onTrue.tco_run() : onFalse.get();
    }
